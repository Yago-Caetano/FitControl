...
public class CatracaRestartListenner implements ISubscriber{
    @Override
    public void update(FitControlContext context){
        ...
        ser.sendData(catracaModel.getId().getBytes(StandardCharsets.UTF_8), EnumSerialFunctions.RESTART);
    }
}
